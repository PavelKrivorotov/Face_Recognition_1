...
class BaseProcessing:
    ...
    def check_images(self):
        ...
        for photo in self._check_photos_dir.glob('*'):
            ...
            state, name = self._compare_face(encodings)
            print(
                '\n',
                '\nState = ', state,
                '\nName = ', name,
            ...
            # Draw face rectangle:
            img = self._draw_rectangle(img, rectangle_coords, name)

            # # Write face encoding:
            # encoding_photo_path = Path(dir_path, 'encoding.json')
            # self._write_face_encodings()
    ...
    def _draw_rectangle(self, img, coords, text=None):
        for coord in coords:
            ...
            img = cv2.rectangle(img, start_point, stop_point, (0, 0, 255), 2)
    ...
    # def _write_face_encodings(self):
    def _write_face_encodings(self, file_path):
        ...
        # with open(self._initial_photos_json, 'w', encoding='utf-8') as file:
    ...
    # def _read_face_encodings(self):
    def _read_face_encodings(self, file_path):
        # with open(self._initial_photos_json, encoding='utf-8') as file:
...
if __name__ == '__main__':
    ...
    p.load_encodings()
    # print(p._initial_photos_encodigs)
